...
public class EmployeeRestController {
    ...
    public String updateEmployee(ModelMap modelMap, @Validated @ModelAttribute("employee") Employee employee, BindingResult bindingResult, Model model, Pageable pageable) {
